...
import com.osreboot.ridhvl.menu.component.collection.HvlExpandableRectButton;
...
public class ComponentsTest extends HvlTemplate2DBasic {
	...
	public void initialize() {
		...
		// }
		// };
		testButton = new HvlExpandableRectButton(64, 64, 256, 128, 720,
				...
				new HvlExpandingRectangle(textureLoader.getResource(4), 0.125f,
						0.875f, 0.125f, 0.875f, 0, 0, 0, 0, 16, 16),
				new HvlExpandingRectangle(textureLoader.getResource(3), 0.125f,
						0.875f, 0.125f, 0.875f, 0, 0, 0, 0, 16, 16));
