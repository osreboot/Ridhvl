...
public class ComponentsTest extends HvlTemplate2D {
	...
	public void initialize() {
		...
		testCheck = new HvlCheckbox.Builder().setWidth(64).setHeight(64)
		...
		testButton = new HvlTextButton.Builder().setX(64).setY(64).setWidth(256).setHeight(128)
				.setOffDrawable(new HvlTextureDrawable(textureLoader.getResource(2))).setHoverDrawable(new HvlTextureDrawable(textureLoader.getResource(3)))
				.setOnDrawable(new HvlTextureDrawable(textureLoader.getResource(4))).setFont(fontPainter).setText("hey!").setTextScale(0.5f)
				.setTextColor(Color.red).setxAlign(0.5f).setyAlign(0.5f).build();

		testTextBox = new HvlTextBox.Builder().setWidth(512).setHeight(96).setText("hey").setFocusedDrawable(new HvlTiledRectDrawable(new HvlTiledRect(textureLoader.getResource(2), 0.125f, 0.875f, 0.125f,
				0.875f, 0, 0, 0, 0, 16, 16))).setUnfocusedDrawable(new HvlTiledRectDrawable(new HvlTiledRect(textureLoader.getResource(4), 0.125f, 0.875f, 0.125f, 0.875f, 0, 0, 0,
				0, 16, 16))).setFont(fontPainter).setTextScale(0.4f).setMaxCharacters(10).setForceLowercase(true).setOffsetX(12f).setOffsetY(12f).build();
		
		testSlider = new HvlSlider.Builder().setWidth(32).setHeight(512).setDirection(SliderDirection.VERTICAL).setHandleWidth(16).setHandleHeight(16).setValue(0.0f)
				.setHandleUpDrawable(new HvlTextureDrawable(textureLoader.getResource(6))).setHandleDownDrawable(new HvlTextureDrawable(textureLoader.getResource(7)))
				.setBackground(new HvlTextureDrawable(textureLoader.getResource(5))).setHandleStartOffset(8).setHandleEndOffset(8).setSnapInterval(0.1f).build();

		testListBox = new HvlListBox.Builder().setWidth(512).setHeight(256).setScrollBar(testSlider)
				.setFont(new HvlFontPainter2D(textureLoader.getResource(1), HvlFontUtil.DEFAULT, 2048, 2048, 112, 144, 18))
				...
				.setAutoSize(true).setBackground(new HvlTextureDrawable(textureLoader.getResource(2))).setFullBackground(true).addItem("hey")
				.addItem("nice to meet you").addItem("nice to be you").addItem("derp!").addItem("derp2!").addItem("derp3!").addItem("derp4!").addItem("derp5!")
				.addItem("derp6!").addItem("derp7!").build();

		
		testArranger = new HvlArrangerBox.Builder().setX(64).setY(64).setWidth(1280).setHeight(720).setStyle(ArrangementStyle.VERTICAL).add(testLabel).add(testCheck)
				.add(testButton).add(testTextBox).add(testListBox).setAlign(0.0f).build();
