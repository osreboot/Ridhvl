...
public abstract class HvlTemplateInteg2DA extends HvlTemplate{

	public static final HvlEvent1<HvlTemplateInteg2DA> EVENT_EXIT = new HvlEvent1<>();
	
	public static Texture getTexture(int indexArg){
		return ((HvlTemplateInteg2DA)HvlTemplate.getNewestInstance()).getTextureLoader().getResource(indexArg);
	}
	
	public static ArrayList<Texture> getTextureSeries(int indexArg){
		return ((HvlTemplateInteg2DA)HvlTemplate.getNewestInstance()).getTextureLoader().getResourceSeries(indexArg);
	}
	
	public static Audio getSound(int indexArg){
		return ((HvlTemplateInteg2DA)HvlTemplate.getNewestInstance()).getSoundLoader().getResource(indexArg);
	}
	
	public static ArrayList<Audio> getSoundSeries(int indexArg){
		return ((HvlTemplateInteg2DA)HvlTemplate.getNewestInstance()).getSoundLoader().getResourceSeries(indexArg);
	}
	...
	public HvlTemplateInteg2DA(int frameRateArg, int width, int height, String title, HvlDisplayMode displayModeArg){
		super();
	...
	public HvlTemplateInteg2DA(int frameRateArg, int width, int height, String title, String iconName, HvlDisplayMode displayModeArg){
		super();
