...
public class HvlCP_XBoxOne extends HvlControllerProfile{

	public HvlCP_XBoxOne(){
		super(HvlCP_XBoxOne.class, "Controller (Xbox One For Windows)");
	}
	
	@HvlPollValue(component = "X Axis", deadZone = 0.25f)
	public static final String JOY1X = "JOY1X";
	
	@HvlPollValue(component = "Y Axis", deadZone = 0.25f, amplifier = -1f)
	public static final String JOY1Y = "JOY1Y";
	
	@HvlPollValue(component = "X Rotation", deadZone = 0.25f)
	public static final String JOY2X = "JOY2X";
	
	@HvlPollValue(component = "Y Rotation", deadZone = 0.25f, amplifier = -1f)
